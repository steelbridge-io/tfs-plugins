...
update_post_meta( $post_id, 'feature-2-read-more-info', $_POST[ 'feature-2-read-more-info' ] );
}
...
if( isset( $_POST[ 'feature-3-read-more-info' ] ) ) {
  update_post_meta( $post_id, 'feature-3-read-more-info', $_POST[ 'feature-3-read-more-info' ] );
}
...
if( isset( $_POST[ 'feature-4-read-more-info' ] ) ) {
  update_post_meta( $post_id, 'feature-4-read-more-info', $_POST[ 'feature-4-read-more-info' ] );
}
...
if( isset( $_POST[ 'feature-5-read-more-info' ] ) ) {
  update_post_meta( $post_id, 'feature-5-read-more-info', $_POST[ 'feature-5-read-more-info' ] );
}
