...
Contributors: sillybean, chris in redding
Tags: widgets, excerpts
Donate link: http://chrisjparsons.com/code/wordpress/recent-posts-with-excerpts/
...
= 2.2 =
* Fixed HTML validation error. (Thanks, Chris in Redding!)
= 2.1 =
