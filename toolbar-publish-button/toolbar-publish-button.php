...
class tpb {
    ...
    function initialize() {
        ...
        // filters
        add_filter( 'plugin_row_meta', array( $this, 'tpb_rate_us' ), 10, 4 );
    ...
    function sanitize_tpb_settings( $input ) {
        ...
        $input['buttons_to_the_right'] = isset( $input['buttons_to_the_right'] ) && !! $input['buttons_to_the_right'] ? 1 : 0;
                    ...
                    <div id="postbox-container-1" class="postbox-container">
                        ...
                        <div class="postbox" id="wpuxss-credit">
                            ...
                            <div class="inside">
                                ...
                                <h4><?php _e( 'Toolbar Publish Button users ONLY', 'toolbar-publish-button' ); ?></h4>
                                    <p><a href="https://wpuxsolutions.com/pricing?coupon=TPBFAN" target="_blank" class="button button-primary"><span>52% OFF</span> DISCOUNT</a> for the Premium Version of <a href="https://wpuxsolutions.com/plugins/enhanced-media-library" target="_blank">Enhanced Media Library</a> plugin</p>
    ...
    /**
     *  Adds Rate Us block to the plugin action links.
     *
     *  @type   filter callback
     *  @since  1.7
     *  @date   14/10/20
    ...
    function tpb_rate_us( $links, $file, $plugin_data, $status ) {

        if ( $this->get_option( 'basename' ) !== $file ) {
            return $links;
        }

        $links[] = __( 'Rate us:', 'toolbar-publish-button' ) . " <span class='rating-stars'><a href='//wordpress.org/support/plugin/toolbar-publish-button/reviews/?rate=1#new-post' target='_blank' data-rating='1' title='" . __('Poor', 'toolbar-publish-button') . "'><span class='dashicons dashicons-star-filled' style='color:#ffb900 !important;'></span></a><a href='//wordpress.org/support/plugin/toolbar-publish-button/reviews/?rate=2#new-post' target='_blank' data-rating='2' title='" . __('Works', 'toolbar-publish-button') . "'><span class='dashicons dashicons-star-filled' style='color:#ffb900 !important;'></span></a><a href='//wordpress.org/support/plugin/toolbar-publish-button/reviews/?rate=3#new-post' target='_blank' data-rating='3' title='" . __('Good', 'toolbar-publish-button') . "'><span class='dashicons dashicons-star-filled' style='color:#ffb900 !important;'></span></a><a href='//wordpress.org/support/plugin/toolbar-publish-button/reviews/?rate=4#new-post' target='_blank' data-rating='4' title='" . __('Great', 'toolbar-publish-button') . "'><span class='dashicons dashicons-star-filled' style='color:#ffb900 !important;'></span></a><a href='//wordpress.org/support/plugin/toolbar-publish-button/reviews/?rate=5#new-post' target='_blank' data-rating='5' title='" . __('Fantastic!', 'toolbar-publish-button') . "'><span class='dashicons dashicons-star-filled' style='color:#ffb900 !important;'></span></a><span>";
