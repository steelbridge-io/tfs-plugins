...
function travel_blog() {
    ...
    $labels = array(
        'name'                  => _x( 'Travel Posts', 'Post Type General Name', 'travel_domain' ),
        'singular_name'         => _x( 'Travel Post', 'Post Type Singular Name', 'travel_domain' ),
        'menu_name'             => __( 'Travel Posts', 'travel_domain' ),
        'name_admin_bar'        => __( 'Travel Post', 'travel_domain' ),
    ...
    $args = array(
        'label'                 => __( 'Travel Posts', 'travel_domain' ),
        'description'           => __( 'Travel Blog Posts', 'travel_domain' ),
        'labels'                => $labels,
...
// Custom Taxonomy
add_action('init', 'custom_travelblog_tax');
