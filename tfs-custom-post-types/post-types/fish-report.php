...
add_post_type_support( 'fish_report', 'thumbnail' );

// Register Custom Post Type
function fish_report() {

	$labels = array(
		'name'                  => _x( 'Fishing Reports', 'Post Type General Name', 'travel_domain' ),
		'singular_name'         => _x( 'Fishing Reports', 'Post Type Singular Name', 'travel_domain' ),
		'menu_name'             => __( 'Fishing Reports', 'travel_domain' ),
		'name_admin_bar'        => __( 'Fishing Reports', 'travel_domain' ),
	...
	$args = array(
		'label'                 => __( 'Fishing Reports', 'travel_domain' ),
		'description'           => __( 'Fishing Reports', 'travel_domain' ),
		'labels'                => $labels,
		...
		'show_in_rest'          => true,
		'rewrite' => array('slug' => 'fish-report', 'with_front' => false ),
	);
	register_post_type( 'fish_report', $args );

}
add_action( 'init', 'fish_report', 0 );

// Custom Taxonomy
add_action('init', 'fish_report_tax');
function fish_report_tax() {
	register_taxonomy(
		'report-category',
		'fish_report',
		array(
			'hierarchical'	    => true,
			'label'			    => __('Report Categories'),
			'show_ui'           => true,
