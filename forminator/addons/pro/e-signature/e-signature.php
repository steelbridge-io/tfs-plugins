...
class Forminator_E_Signature {
	...
	private function __construct() {
		...
		add_filter( 'forminator_handle_specific_field_types', [ 'Forminator_E_Signature', 'handle_signature' ], 10, 4 );
	}
	 ...
	 * @return array|string
	 */
	public static function handle_signature( $field_data, $form_field_obj, $field_array, $submission_behav ) {
