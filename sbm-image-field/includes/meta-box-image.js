...
// Instantiates the variable that holds the media library frame.
    var outfitters_blog_image_frame;
    ...
    $('#outfitters-logo-button').click(function(e){
        ...
        // If the frame already exists, re-open it.
        if ( outfitters_blog_image_frame ) {
            outfitters_blog_image_frame.open();
            return;
        }

        // Sets up the media library frame
        outfitters_blog_image_frame = wp.media.frames.outfitters_blog_image_frame = wp.media({
            title: meta_image.title,
            button: { text:  meta_image.button },
            library: { type: 'image' }
        });
        ...
        // Runs when an image is selected.
        outfitters_blog_image_frame.on('select', function(){

            // Grabs the attachment selection and creates a JSON representation of the model.
            var media_attachment = outfitters_blog_image_frame.state().get('selection').first().toJSON();
