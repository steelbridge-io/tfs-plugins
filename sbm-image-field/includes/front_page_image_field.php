...
include( plugin_dir_path( __FILE__ ) . '../inc/sanitize_front_page_image.php');
	...
	function front_page_custom_meta() { global $post;
		...
		if(!empty($post)) {
			...
			if($pageTemplate == 'page-templates/front-page-template.php') {
				add_meta_box ( 'front_page_meta', __('Front Page Images And Content', 'front-page-textdomain' ), 'front_page_meta_callback', $type, 'normal', 'high');
				}
			}
		}
	}
	...
	<label for="front-page-hero" class="front-page-row-title"><?php _e( '<h3>Header Image</h3>', 'front-page-textdomain' );?></label>
   ...
   <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">	
	...
	<label for="front-page-logo" class="front-page-row-title"><?php _e( '<h3>TFS Logo</h3>', 'front-page-textdomain' );?></label>
	...
	<input type="button" id="front-page-logo-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />
	...
	<label for="front-page-image" class="front-page-row-title"><?php _e( '<h3>Front Page Images</h3>', 'front-page-textdomain' );?></label><br>
		...
		<!-- Nav tabs -->
			...
			<div class="panel-body boof">
				<div class="tab-content">
					...
					<label for="front-page-image-1" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;1</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					
					<!-- Front Page image #1 title. -->
					<strong><label for="front-page-image-1-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;1 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-1-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;1 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<!-- Front Page image #1-->
					<strong><label for="front-page-image-1" class="front-page-row-title"><?php _e( 'Front Page Image &#35;1', 'front-page-textdomain' );?></label></strong><br>
					...
					<input type="button" id="front-page-image-1-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />
					...
					<strong><label for="front-page-image-1-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;1 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-1-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;1 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-2" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;2</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					
					<!-- Front Page image #2 title. -->
					<strong><label for="front-page-image-2-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;2 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-2-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;2 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #2. -->
					<strong><label for="front-page-image-2" class="front-page-row-title"><?php _e( 'Front Page Image &#35;2', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-2-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />
					...
					<strong><label for="front-page-image-2-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;2 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-2-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;2 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-3" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;3</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					
					<!-- Front Page image #3 title. -->
					<strong><label for="front-page-image-3-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;3 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-3-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;3 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #3 -->
					<strong><label for="front-page-image-3" class="front-page-row-title"><?php _e( 'Front Page Image &#35;3', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-3-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #3 sub-title. -->
					<strong><label for="front-page-image-3-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;3 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-3-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;3 Caption', 'front-page-textdomain' )?></label></strong>
	...
	<div class="panel with-nav-tabs panel-default">
			...
			<div class="panel-body boof">
				<div class="tab-content">
					...
					<label for="front-page-image-4" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;4</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					<!-- Front Page image #4 title. -->
					<strong><label for="front-page-image-4-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;4 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-4-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;4 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<!-- Front Page #4 image -->
					<strong><label for="front-page-image-4" class="front-page-row-title"><?php _e( 'Front Page Image &#35;4', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-4-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #4 sub-title. -->
					<strong><label for="front-page-image-4-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;4 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-4-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;4 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-5" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;5</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					<!-- Front Page image #5 title. -->
					<strong><label for="front-page-image-5-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;5 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-5-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;5 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #5. -->
					<label for="front-page-image-5" class="front-page-row-title"><?php _e( 'Front Page Image &#35;5', 'front-page-textdomain' );?></label>
					...
					<input type="button" id="front-page-image-5-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #5 sub-title. -->
					<strong><label for="front-page-image-5-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;5 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-5-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;5 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-6" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;6</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					<!-- Front Page image #6 title. -->
					<strong><label for="front-page-image-6-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;6 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-6-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;6 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #6. -->
					<strong><label for="front-page-image-6" class="front-page-row-title"><?php _e( 'Front Page Image &#35;6', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-6-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #6 sub-title. -->
					<strong><label for="front-page-image-6-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;6 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-6-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;6 Caption', 'front-page-textdomain' )?></label></strong>
		...
		<!-- Nav tabs -->
			...
			<div class="panel-body boof">
				<div class="tab-content">
					...
					<label for="front-page-image-7" class="front-page-row-title"><?php _e( '<h3>Front Page Image &#35;7</h3>', 'front-page-textdomain' );?></label>
					
					<p>
					<!-- Front Page image #7 title. -->
					<strong><label for="front-page-image-7-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;7 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-7-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;7 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page Image #7. -->
					<strong><label for="front-page-image-7" class="front-page-row-title"><?php _e( 'Front Page Image &#35;7', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-7-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #7 sub-title. -->
					<strong><label for="front-page-image-7-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;7 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-7-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;7 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-8" class="front-page-row-title"><?php _e('<h3>Front Page Image &#35;8</h3>', 'front-page-textdomain') ?></label>
					
					<p>
					<!-- Front Page image #8 title. -->
					<strong><label for="front-page-image-8-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;8 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-8-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;8 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #8. -->
					<strong><label for="front-page-image-8" class="front-page-row-title"><?php _e( 'Front Page Image &#35;8', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-8-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #8 sub-title. -->
					<strong><label for="front-page-image-8-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;8 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-8-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;8 Caption', 'front-page-textdomain' )?></label></strong>
					...
					<label for="front-page-image-9" class="front-page-row-title"><?php _e('<h3>Front Page Image &#35;9</h3>', 'front-page-textdomain') ?></label>
					
					<p>
					<!-- Front Page image #9 title. -->
					<strong><label for="front-page-image-9-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;9 Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-9-title-link" class="front-page-row-title-link"><?php _e( 'Front Page Image &#35;9 Title Link', 'front-page-textdomain' );?></label></strong>
					...
					<p> 
					<!-- Front Page image #9. -->
					<strong><label for="front-page-image-9" class="front-page-row-title"><?php _e( 'Front Page Image &#35;9', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="front-page-image-9-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
					
					<p>
					<!-- Front Page image #9 sub-title. -->
					<strong><label for="front-page-image-9-sub-title" class="front-page-row-title"><?php _e( 'Front Page Image &#35;9 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="front-page-image-9-caption" class="front-page-row-title"><?php _e( 'Front Page Image &#35;9 Caption', 'front-page-textdomain' )?></label></strong>
  ...
  <div class="panel with-nav-tabs panel-default">
    <div class="panel-heading">
       <label for="flippage1" class="front-page-row-title"><?php _e( '<h3>Flip Page Catalog</h3>', 'front-page-textdomain' );?></label>
    <!-- Nav Tabs -->
    <ul class="nav nav-tabs" role="tablist">
      ...
      <div class="panel-body boof">
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane fade in active" id="flippage1">
            ...
            <label for="flippage1" class="front-page-row-title"><?php _e( '<h3>Flip Page Catalog &#35;1</h3>', 'front-page-textdomain' );?></label>
                        
            <p>

            <!-- Flip Page Catalog #1 title. -->
            <strong><label for="flippage1-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;1 Title', 'front-page-textdomain' );?></label></strong>
            ...
            <strong><label for="flippage1-title-link" class="front-page-row-title-link"><?php _e( 'Flip Page Catalog &#35;1 Title Link', 'front-page-textdomain' );?></label></strong>
            ...
            <strong><label for="flippage1-image" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;1 Image', 'front-page-textdomain' );?></label></strong>
            ...
            <input type="button" id="flippage1-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

            </p>
            
            <p>
            <!-- Flip Page Catalog #1 sub-title. -->
            <strong><label for="flippage1-sub-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;1 Sub-Title', 'front-page-textdomain' );?></label></strong>
            ...
            <strong><label for="flippage1-caption" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;1 Caption', 'front-page-textdomain' )?></label></strong>
          ...
          <label for="flippage2" class="front-page-row-title"><?php _e('<h3>Flip Page Catalog &#35;2</h3>', 'front-page-textdomain') ?></label>
            
          <div sytle="margin: 1.618em auto">
            
          <span class="travel-row-title"><?php _e( '<strong>Activate Flip Page Catalog #2</strong>', 'front-page-textdomain' )?></span>
          ...
          <?php _e( 'Check box to activate Flip Page #2', 'front-page-textdomain' )?>
          </label>
          </div>
          ...
          <strong><label for="flippage2-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;2 Title', 'front-page-textdomain' );?></label></strong>
          ...
          <strong><label for="flippage2-title-link" class="front-page-row-title-link"><?php _e( 'Flip Page Catalog &#35;2 Title Link', 'front-page-textdomain' );?></label></strong>
          <input style="width: 100%;" type="text" name="flippage2-title-link" id="flippage2-title-link" value="<?php if ( isset ( $front_page_stored_meta['flippage2-title-link'] ) ) echo $front_page_stored_meta['flippage2-title-link'][0]; ?>" />
					...
					<strong><label for="flippage2-image" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;2 Image', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="flippage2-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
            
					<p>
					<!-- Flip Page Catalog #2 Sub-title. -->
					<strong><label for="flippage2-sub-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;7 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="flippage2-caption" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;7 Caption', 'front-page-textdomain' )?></label></strong>
          ...
          <div role="tabpanel" class="tab-pane fade" id="flippage3">
            <label for="flippage2" class="front-page-row-title"><?php _e('<h3>Flip Page Catalog &#35;3</h3>', 'front-page-textdomain') ?></label>
            
          <div sytle="margin: 1.618em auto">
            
          <span class="travel-row-title"><?php _e( '<strong>Activate Flip Page Catalog #3</strong>', 'front-page-textdomain' )?></span>
          <div class="travel-row-content">
          ...
          <?php _e( 'Check box to activate Flip Page #3', 'front-page-textdomain' )?>
          </label>
          </div>
          ...
          <strong><label for="flippage3-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;3 Title', 'front-page-textdomain' );?></label></strong>
          ...
          <strong><label for="flippage3-title-link" class="front-page-row-title-link"><?php _e( 'Flip Page Catalog &#35;3 Title Link', 'front-page-textdomain' );?></label></strong>
          <input style="width: 100%;" type="text" name="flippage3-title-link" id="flippage3-title-link" value="<?php if ( isset ( $front_page_stored_meta['flippage3-title-link'] ) ) echo $front_page_stored_meta['flippage3-title-link'][0]; ?>" />
					...
					<strong><label for="flippage3-image" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;3 Image', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="flippage3-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
            
					<p>
					<!-- Flip Page Catalog #3 Sub-title. -->
					<strong><label for="flippage3-sub-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;3 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="flippage3-caption" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;3 Caption', 'front-page-textdomain' )?></label></strong>
          ...
          <label for="flippage2" class="front-page-row-title"><?php _e('<h3>Flip Page Catalog &#35;4</h3>', 'front-page-textdomain') ?></label>
            
          <div sytle="margin: 1.618em auto">
            
          <span class="travel-row-title"><?php _e( '<strong>Activate Flip Page Catalog #4</strong>', 'front-page-textdomain' )?></span>
          <div class="travel-row-content">
          ...
          <?php _e( 'Check box to activate Flip Page #4', 'front-page-textdomain' )?>
          </label>
          </div>
          ...
          <strong><label for="flippage4-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;4 Title', 'front-page-textdomain' );?></label></strong>
          ...
          <strong><label for="flippage4-title-link" class="front-page-row-title-link"><?php _e( 'Flip Page Catalog &#35;4 Title Link', 'front-page-textdomain' );?></label></strong>
          <input style="width: 100%;" type="text" name="flippage4-title-link" id="flippage4-title-link" value="<?php if ( isset ( $front_page_stored_meta['flippage4-title-link'] ) ) echo $front_page_stored_meta['flippage4-title-link'][0]; ?>" />
					...
					<strong><label for="flippage4-image" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;4 Image', 'front-page-textdomain' );?></label></strong>
					...
					<input type="button" id="flippage4-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'front-page-textdomain' );?>" />

					</p>
            
					<p>
					<!-- Flip Page Catalog #4 Sub-title. -->
					<strong><label for="flippage4-sub-title" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;4 Sub-Title', 'front-page-textdomain' );?></label></strong>
					...
					<strong><label for="flippage4-caption" class="front-page-row-title"><?php _e( 'Flip Page Catalog &#35;4 Caption', 'front-page-textdomain' )?></label></strong>
	...
	<label for="front-page-image-10" class="front-page-row-title"><?php _e('<h3>Front Page Call-To-Action</h3>', 'front-page-textdomain') ?></label>

	<p>
	<!-- Front Page CTA title. -->
	<strong><label for="front-page-cta-title" class="front-page-cta-title"><?php _e( 'Front Page CTA Title', 'front-page-textdomain' );?></label></strong>
	...
	<strong><label for="front-page-cta-content" class="front-page-cta-content"><?php _e( 'Front Page Image &#35;10 Caption', 'front-page-textdomain' )?></label></strong>
