...
function travel_custom_meta() { global $post;
  ...
  if(!empty($post)) {
    ...
    if($pageTemplate == 'page-templates/travel-template.php') {
      add_meta_box ( 'travel_meta', __('Travel Images', 'the-fly-shop' ), 'travel_meta_callback', $types, 'normal', 'high');
    }
  }
}
...
function travel_meta_callback( $post ) {
  ...
  <p> <!-- ==== TRAVEL HERO IMAGE ==== -->
    ...
    <input type="button" id="travel-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  </p>
  <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
  <p> <!-- ==== COST / TRAVEL DETAILS IMAGE ==== -->
    <label for="feature-1-image" class="travel-row-title"><?php _e( '<h3>Costs Imagery</h3>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="feature-1-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  </p>
  
  <p> <!-- ==== COST / TRAVEL TEXT/VIDEO ==== -->
    <label for="feature-1-video" class="travel-row-title"><?php _e( '<strong>Video (Enter Public URL):</strong>', 'the-fly-shop' )?></label>
  ...
  <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
  <p> <!-- ==== SEASONS IMAGE ==== -->
    <label for="feature-2-image" class="travel-row-title"><?php _e( '<h3>Seasons Imagery</h3>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="feature-2-image-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  </p>
  
  <p> <!-- ==== SEASONS / TRAVEL TEXT/VIDEO ==== -->
    <label for="feature-2-video" class="travel-row-title"><?php _e( '<strong>Video (Enter Public URL):</strong>', 'the-fly-shop' )?></label>
  ...
  <p> <!-- ==== GETTING TO THE DESTINATION ==== -->
    <label for="feature-3-gettingto-image" class="travel-row-title"><?php _e( '<h3>Getting To Destination Imagery</h3>', 'the-fly-shop' );?></label>
  ...
  <p> <!-- ==== GETTING TO / TRAVEL TEXT/VIDEO ==== -->
    <label for="feature-3-video" class="travel-row-title"><?php _e( '<strong>Video (Enter Public URL):</strong>', 'the-fly-shop' )?></label>
  ...
  <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
  <p> <!-- ==== LODGING ==== -->
    <label for="feature-4-lodging-image" class="travel-row-title"><?php _e( '<h3>Lodging Imagery</h3>', 'the-fly-shop' );?></label>
  ...
  <p> <!-- ==== LODGING / TRAVEL TEXT/VIDEO ==== -->
    <label for="feature-4-video" class="travel-row-title"><?php _e( '<strong>Video (Enter Public URL):</strong>', 'the-fly-shop' )?></label>
  ...
  <hr style="margin-top: 1.618em; border-top: 3px double #8c8b8b;">
  <p> <!-- ==== FISHING / ANGLING ==== -->
    <label for="feature-5-angling-image" class="travel-row-title"><?php _e( '<h3>Fishing Imagery</h3>', 'the-fly-shop' );?></label>
  ...
  <p> <!-- ==== FISHING / TRAVEL TEXT/VIDEO ==== -->
    <label for="feature-5-video" class="travel-row-title"><?php _e( '<strong>Video (Enter Public URL):</strong>', 'the-fly-shop' )?></label>
  ...
  <div class="panel">
    ...
    <label for="sth-section" class="travel-row-title"><?php _e( '<h3>Set The Hook Section</h3>', 'the-fly-shop' );?></label>
    ...
    <div class="set-the-hook-container">
      ...
      <div>
        ...
        <div class="travel-row-content">
          <label for="sth-textarea-1" class="sth-textarea-1"><?php _e( '<strong>Set The Hook Section</strong>', 'the-fly-shop' )?></label>
  ...
  <p> <!-- Additional Image #1 -->
    ...
    <label for="additional-info-image1" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;1</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image1-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #2 -->
    
    <label for="additional-info-image2" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;2</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image2-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #3 -->
    
    <label for="additional-info-image3" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;3</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image3-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #4 -->
    
    <label for="additional-info-image4" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;4</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image4-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #5 -->
    
    <label for="additional-info-image5" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;5</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image5-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #6 -->
    
    <label for="additional-info-image6" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;6</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image6-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #7 -->
    
    <label for="additional-info-image7" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;7</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image7-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
  
  </p>
  
  <p> <!-- Additional Image #8 -->
    
    <label for="additional-info-image8" class="travel-row-title"><?php _e( '<strong>Additional Image &#35;8</strong>', 'the-fly-shop' );?></label>
    ...
    <input type="button" id="additional-info-image8-button" class="button" value="<?php _e( 'Choose or Upload an Image', 'the-fly-shop' );?>" />
