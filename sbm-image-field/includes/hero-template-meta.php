<?php
  ...
  function hero_temp_custom_meta() { global $post;
    if(!empty($post)) {
      ...
      if($pageTemplate == 'page-templates/hero-template.php') {
        ...
        foreach($types as $type) {
          add_meta_box( 'hero_temp_meta', __( 'Hero Template Settings', 'the-fly-shop' ), 'hero_temp_meta_callback', $type, 'normal', 'high' );
        }
      }
    }
  }
...
?>
    ...
    <p>
	  ...
	  <p> <!-- Hero Image -->
		  ...
		  <input type="text" style="width:80%;" name="hero-temp-image" id="hero-temp-image" value="<?php if ( isset ( $hero_temp_stored_meta['hero-temp-image'] ) ) echo $hero_temp_stored_meta['hero-temp-image'][0];?>" />
    ...
    <select name="hero-template-select-sidebar" id="hero-template-select-sidebar">
      ...
      <option value="lavacreeklodge" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'lavacreeklodge' ); ?>><?php _e( 'Lava Creek Lodge', 'the-fly-shop' )?></option>';
      <option value="lower48" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'lower48' ); ?>><?php _e( 'Lower 48', 'the-fly-shop' )?></option>';
      <option value="news" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'news' ); ?>><?php _e( 'News', 'the-fly-shop' )?></option>';
      <option value="outfitter" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'outfitter' ); ?>><?php _e( 'Outfitters', 'the-fly-shop' )?></option>';
      <option value="retail" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'retail' ); ?>><?php _e( 'Retail', 'the-fly-shop' )?></option>';
      <option value="survey" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'survey' ); ?>><?php _e( 'Survey', 'the-fly-shop' )?></option>';
      <option value="travel" <?php if ( isset ( $hero_temp_store_meta['hero-template-select-sidebar'] ) ) selected( $hero_temp_store_meta['hero-template-select-sidebar'][0], 'travel' ); ?>><?php _e( 'Travel', 'the-fly-shop' )?></option>';
    </select>
    </p>
