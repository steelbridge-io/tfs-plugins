...
function private_meta_callback( $post ) {
  ...
  <p> <!-- ==== FEATURE #1 / PRIVATE WATERS TEXT/VIDEO ==== -->
    ...
    <label for="feature-pw1-video" class="private-row-title"><?php _e( '<strong>Paste implicit video URL here. No shortened versions:</strong>', 'private-textdomain' )?></label>
  ...
  <p> <!-- ==== FEATURE #2 / TRAVEL TEXT/VIDEO ==== -->
    ...
    <label for="feature-pw2-video" class="private-row-title"><?php _e( '<strong>Paste implicit video URL here. No shortened versions:</strong>', 'private-textdomain' )?></label>
  ...
  <p> <!-- ==== FEATURE #4 / LODGING TEXT/VIDEO ==== -->
    ...
    <label for="feature-pw4-video" class="private-row-title"><?php _e( '<strong>Paste implicit video URL here. No shortened versions:</strong>', 'private-textdomain' )?></label>
  ...
  <p> <!-- ==== FEATURE #5 / FISHING TEXT/VIDEO ==== -->
    ...
    <label for="feature-pw5-video" class="private-row-title"><?php _e( '<strong>Paste implicit video URL here. No shortened versions:</strong>', 'private-textdomain' )?></label>
